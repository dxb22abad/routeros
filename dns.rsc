...
add comment=Quora forward-to=10.2.2.250 regexp=".*(\\.)\?quora\\.com" type=\
    FWD
add comment=Yahoo forward-to=10.2.2.250 regexp=".*(\\.)\?(yahoo|yimg)\\.com" \
    type=FWD
add comment=DAZN forward-to=10.2.2.250 regexp=".*(\\.)\?dazn\\.com" type=FWD
add comment=Linux forward-to=10.2.2.250 regexp="*.\\.(linuxfoundation|redhat|s\
    use|opensuse|debian|ubuntu|alpine)\\.(org|com)\$" type=FWD
add comment=Linux forward-to=10.2.2.250 regexp=\
...
add comment=HBO forward-to=10.2.2.250 regexp=".*(\\.)\?boltdns\\.net" type=\
    FWD
add comment=Pornhub forward-to=10.2.2.250 regexp=\
